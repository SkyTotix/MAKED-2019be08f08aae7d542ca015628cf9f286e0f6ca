...
public class CancelarCitaExitosaController {

    @FXML private Button btnContinuar;

    @FXML
    private void initialize() {
        System.out.println("CancelarCitaExitosaController inicializando...");
        
        // Configurar efecto hover para el botón
        configurarEfectoHover();
        
        System.out.println("CancelarCitaExitosaController inicializado correctamente");
    }
